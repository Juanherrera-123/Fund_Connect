...
const translations = {
  en: {
    ...
    heroTitle: 'Where Capital Meets Conviction.',
  ...
  es: {
    ...
    heroTitle: 'Donde el capital se encuentra con la convicción.',
  ...
  it: {
    ...
    navInsights: 'Insights',
    navContact: 'Contatti',
    navManagers: 'Per Gestori',
    navFamily: 'Family Offices',
    navRequestDemo: 'Richiedi Demo',
    heroEyebrow: 'Accesso Istituzionale',
    heroTitle: 'Dove il capitale incontra la convinzione.',
