...
export function MarketInfrastructureSection() {
  return (
    <section id="compliance" className="bg-[#f6f9ff] py-20">
...
export function MarketInfrastructureTabs() {
  ...
  return (
    <div className="rounded-[28px] bg-gradient-to-br from-white/60 via-white/80 to-slate-50/80 p-4">
              ...
              return (
                ...
                >
                  <button
                    ...
                    className={`flex w-full min-w-[220px] items-start gap-3 rounded-[15px] border px-4 py-3 text-left transition-all duration-200 ease-out lg:min-w-0 ${
                      isActive
