    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        <div className="max-w-3xl space-y-4">
          ...
          <h2 className="text-3xl font-semibold sm:text-4xl lg:text-5xl" data-i18n="learnTitle">
            Cómo se ejecuta capital profesional hoy.
          </h2>
          <p className="text-base text-white/70 sm:text-lg" data-i18n="learnLead">
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]">
            ...
            {learnBlocks.map((block) => (
              ...
              >
                <details className="group/accordion rounded-2xl">
                  <summary className="relative flex cursor-pointer items-center justify-between gap-4 px-5 py-4 pl-6 text-left text-base font-semibold text-white marker:content-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#050f24] sm:px-6 sm:py-5 sm:pl-7 sm:text-lg">
                  ...
                  <div className="grid grid-rows-[0fr] px-5 pb-0 transition-[grid-template-rows] duration-300 ease-out group-open/accordion:grid-rows-[1fr] sm:px-6">
                    <div className="overflow-hidden pb-5 sm:pb-6">
          ...
          <aside className="rounded-2xl border border-[rgba(80,120,255,0.35)] bg-[rgba(255,255,255,0.07)] shadow-[0_18px_40px_rgba(3,10,24,0.45)] backdrop-blur-[6px] transition duration-300 ease-out hover:-translate-y-0.5 hover:shadow-[0_20px_45px_rgba(3,10,24,0.55),_0_0_18px_rgba(80,120,255,0.25)]">
            <div className="flex h-full flex-col gap-4 px-6 py-6 sm:px-8 sm:py-7">
              <h3 className="text-lg font-semibold text-white sm:text-xl" data-i18n="learnMamTitle">
