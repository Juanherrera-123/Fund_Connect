  ...
  if (!profile) {
    return (
      <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-600">
        {strings.dashboardInvestorLoginPrompt}
      </div>
    );
  }
  ...
  return (
    <>
      <header className="flex flex-col gap-2">
        ...
        <h1 className="text-2xl font-semibold text-slate-900">{strings.dashboardInvestorTitle}</h1>
        <p className="text-sm text-slate-600">{strings.dashboardInvestorLead}</p>
      </header>
      ...
      <section className="grid gap-4 lg:grid-cols-[minmax(0,1fr),minmax(0,1fr)]">
        <div className={cardClass}>
          ...
          <div className="mt-4 grid gap-3 text-sm text-slate-600">
            <div className="flex items-center justify-between">
              <span>{strings.dashboardProfileNameLabel}</span>
        ...
        <div className={cardClass}>
          <h2 className="text-sm font-semibold text-slate-700">{strings.dashboardWaitlistSummaryTitle}</h2>
          <div className="mt-4 grid gap-3 text-sm text-slate-600">
            <div className="flex items-center justify-between">
              <span>{strings.dashboardWaitlistTotalRequestsLabel}</span>
