          ...
          <div className="mx-auto w-full max-w-6xl px-6">
            <div className="rounded-2xl border border-slate-200 bg-gradient-to-br from-igates-500/10 to-igates-400/10 p-6">
              <p
                ...
                data-i18n="familyDashboardEyebrow"
              >
                Family Office
              </p>
              <div className="mt-2 flex flex-wrap items-center gap-3">
                <h1 className="text-3xl font-semibold text-slate-900" data-i18n="familyDashboardTitle">
                  Dashboard ampliado de fondos
                </h1>
                <div className="rounded-full border border-igates-500/20 bg-igates-500/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.12em] text-igates-700">
                  <span data-i18n="familyDashboardBadge">Family Office</span>
                </div>
              </div>
              <p className="mt-3 max-w-2xl text-sm text-slate-600" data-i18n="familyDashboardLead">
